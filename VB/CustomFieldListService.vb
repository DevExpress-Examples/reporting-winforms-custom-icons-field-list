...
Namespace FieldListCustomIcons
	...
	Friend Class CustomColumnImageProvider
		...
		Public Overrides Overloads Function GetColumnImageIndex(ByVal [property] As PropertyDescriptor, ByVal specifics As DevExpress.Data.Browsing.Design.TypeSpecifics) As Integer
		...
		Public Overrides Function CreateImageCollection() As DevExpress.Utils.ImageCollection
            ...
            Dim image As Image = ResourceImageHelper.CreateBitmapFromResources("DataPickerImage.png", GetType(CustomColumnImageProvider).Assembly)
